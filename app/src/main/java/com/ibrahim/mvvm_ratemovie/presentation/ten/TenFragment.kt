package com.ibrahim.mvvm_ratemovie.presentation.ten
...
import com.ibrahim.mvvm_ratemovie.databinding.FragmentTenBinding
...
class TenFragment:Fragment() {
    ...
    private fun observeRatedList() {
        viewModel.ratedMovie(10).observe(viewLifecycleOwner) {
